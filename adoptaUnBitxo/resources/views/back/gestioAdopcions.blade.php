    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-xs-center">
                <h3 style="color:white;" class="mbr-section-title display-2">Gestió de les adopcions</h3>            
            </div>
        </div>
    </div>
  ...
  <table class="table">
    ...
    @foreach ($adopcions as $adopcio)
      ...
      <tr>
        ...
        <td><a href = 'gestioAdopcions/{{ $adopcio->id }}/{{$adopcio->animal_id}}'><input type="button" class="btn btn-default" value="Cancela"/></a></td>
      </tr>
    @endforeach
    </tbody>
  </table>
